...
I've provived an example pack, keep the file structure the same or the game will crash.
the game should accept x32 textures, But the script that generate them will be added in a future commit
